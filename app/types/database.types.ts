...
export type Database = {
  ...
  public: {
    Tables: {
      app_users: {
        Row: { created_at: string; email: string; id: string; role: string }
        Insert: { created_at?: string; email: string; id: string; role?: string }
        Update: { created_at?: string; email?: string; id?: string; role?: string }
        Relationships: []
      }
      faqs: {
        Row: {
      ...
      redirects: {
        Row: { created_at: string; from_path: string; id: string; status: number; to_path: string }
        Insert: { created_at?: string; from_path: string; id?: string; status?: number; to_path: string }
        Update: { created_at?: string; from_path?: string; id?: string; status?: number; to_path?: string }
        Relationships: []
      }
      service_items: {
        Row: {
      ...
      stack_groups: {
        Row: { id: string; items: string[]; name: string; sort_order: number }
        Insert: { id?: string; items?: string[]; name: string; sort_order?: number }
        Update: { id?: string; items?: string[]; name?: string; sort_order?: number }
        Relationships: []
      }
    }
